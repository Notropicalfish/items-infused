...
@EventBusSubscriber
public class PunishmentLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<PunishmentLeaveDecorator> CODEC = MapCodec.unit(PunishmentLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("itemsmp:punishment_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public PunishmentLeaveDecorator() {
		super(0.25f);
	}
