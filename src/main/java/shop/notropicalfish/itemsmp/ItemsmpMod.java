...
@Mod("itemsmp")
public class ItemsmpMod {
	public static final Logger LOGGER = LogManager.getLogger(ItemsmpMod.class);
	public static final String MODID = "itemsmp";

	public ItemsmpMod(IEventBus modEventBus) {
